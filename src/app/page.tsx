  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-white">
        ...
        <p className="text-xl text-gray-600 text-left">Empower AI / BI cloud consulting - development, multi-cloud / database support, web application development in Azure, AWS, and GCP. LLM fine-tuning, RAG Architecture, Lang Chain framworks, Agents and custom develpment. Register for our demo / information by going to registraion page.</p>
        </div>
